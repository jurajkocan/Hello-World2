...
export declare const lmap: <F>(profunctor: Profunctor<F>) => <A, B>(f: (a: A) => B) => <C>(fbc: HKT2<F, B, C>) => HKT2<F, A, C>;
export declare const rmap: <F>(profunctor: Profunctor<F>) => <C, D>(g: (c: C) => D) => <B>(fbc: HKT2<F, B, C>) => HKT2<F, B, D>;
