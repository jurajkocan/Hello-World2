...
var Tabs = (function (_super) {
    ...
    Tabs.prototype.render = function () {
        ...
        var tabs = isAvailableArray && childrenArray.filter(function (child) { return child.type === Tab_1.default; });
        ...
        return (React.createElement("div", __assign({}, attributes, { style: styles.root.style, className: styles.root.className }),
            React.createElement("div", __assign({}, styles.titles), tabs && tabs.map(function (tab, index) { return (React.createElement("span", __assign({}, (index === tabFocusIndex ? styles.titleFocus : styles.title), { key: "" + index, onClick: function () { return _this.setState({ tabFocusIndex: index }); } }), renderTitle(tab.props.title || "Tabs Items " + (index + 1)))); })),
            useAnimate ? (React.createElement(CustomAnimate_1.default, { mode: animateMode, speed: animateSpeed, enterStyle: animateEnterStyle, leaveStyle: animateLeaveStyle, wrapperStyle: { width: "100%", height: "100%" }, appearAnimate: false }, normalRender)) : normalRender));
    };
    Tabs.defaultProps = {
