...
var ColorPicker = (function (_super) {
    ...
    function ColorPicker() {
        ...
        _this.handleColorBarChange = function (v) {
            ...
            var _b = _this.props, onChangeColor = _b.onChangeColor, onChangedColor = _b.onChangedColor;
            var colorHexString = tinycolor({ h: h, s: s, v: v }).toHexString();
            onChangeColor(colorHexString);
            _this.setState({ v: v }, function () { return onChangedColor(colorHexString); });
        };
    ...
    ColorPicker.prototype.renderCanvas = function () {
        ...
        for (var i = -1; i < 360; i++) {
            ...
            ctx.closePath();
            var radialGradient = ctx.createRadialGradient(_xPosition, _yPosition, _r, _xPosition, _yPosition, 0);
    ...
    ColorPicker.prototype.render = function () {
        ...
        inlineStyles.colorSelector = __assign({}, inlineStyles.colorSelector, { top: selectorSize, left: selectorSize, width: mainBoardDotSize, height: mainBoardDotSize, borderRadius: mainBoardDotSize, background: "none", boxShadow: "0 0 0 4px #fff" });
        ...
        return (React.createElement("div", __assign({}, attributes, { style: styles.root.style, className: theme.classNames(styles.root.className, className) }),
            React.createElement("div", __assign({}, styles.board),
                React.createElement("div", { style: { position: "relative" } },
                    React.createElement("canvas", __assign({}, styles.mainBoard, { ref: function (canvas) { return _this.canvas = canvas; }, onClick: this.handleChooseColor, onMouseDown: this.handleChooseColor, onMouseUp: this.handleEnd }), "Your Browser not support canvas."),
                    React.createElement("div", { ref: function (colorSelectorElm) { return _this.colorSelectorElm = colorSelectorElm; }, className: styles.colorSelector.className, style: theme.prefixStyle(__assign({}, styles.colorSelector.style, { transform: "translate3d(" + x + "px, " + y + "px, 0)" })) })),
                React.createElement("div", __assign({}, styles.colorMainBar, { ref: function (colorMainBarElm) { return _this.colorMainBarElm = colorMainBarElm; } }))),
            React.createElement(Slider_1.default, { maxValue: 1, onChangeValue: this.handleColorBarChange, style: { marginTop: size * 0.0125, width: "100%" }, initValue: v, width: size, barHeight: size * 0.025, barBackgroundImage: "linear-gradient(90deg, #000, " + halfLightColor.toHexString() + ")", useSimpleController: true })));
    };
