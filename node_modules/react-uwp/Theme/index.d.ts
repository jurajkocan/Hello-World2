...
export declare class Theme extends React.Component<ThemeProps, ThemeState> {
    ...
    prevStyleManager: StyleManager;
    getDefaultTheme: () => ReactUWP.ThemeType;
    getLocalStorageTheme: () => ReactUWP.ThemeType;
    generateAcrylicTextures: (currTheme: ReactUWP.ThemeType, themeCallback?: (theme?: ReactUWP.ThemeType) => void) => void;
    ...
    saveTheme: (newTheme?: ReactUWP.ThemeType, callback?: (theme?: ReactUWP.ThemeType) => void) => void;
