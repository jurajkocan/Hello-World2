...
var generateAcrylicTexture_1 = require("../styles/generateAcrylicTexture");
...
var Theme = (function (_super) {
    ...
    function Theme() {
        ...
        _this.generateAcrylicTextures = function (currTheme, themeCallback) {
            var onGeneratedAcrylic = _this.props.onGeneratedAcrylic;
            _this.acrylicTextureCount = 0;
            var baseConfig = {
                blurSize: 24,
                noiseSize: 1,
        ...
        _this.bindNewThemeMethods = function (theme) {
            ...
            Object.assign(theme, {
                ...
                generateAcrylicTextures: _this.generateAcrylicTextures,
        ...
        _this.updateTheme = function (newTheme, callback) {
            ...
            _this.setState({
                ...
                if (needGenerateAcrylic) {
                    _this.handleNewTheme(newTheme);
                    _this.generateAcrylicTextures(newTheme, function (currTheme) { return _this.setState({ currTheme: currTheme }); });
                }
            });
        };
    ...
    Theme.prototype.componentDidMount = function () {
        ...
        if (currTheme.useFluentDesign && currTheme.desktopBackgroundImage && this.props.needGenerateAcrylic) {
            ...
            this.generateAcrylicTextures(currTheme, function (currTheme) { return _this.setState({ currTheme: currTheme }); });
        }
        ...
        if (nextProps && nextProps.theme && !this.props.autoSaveTheme) {
            if (theme.accent !== currTheme.accent ||
                ...
                this.setState({
                    ...
                    if (needGenerateAcrylic) {
                        _this.handleNewTheme(theme);
                        _this.generateAcrylicTextures(theme, function (currTheme) { return _this.setState({ currTheme: currTheme }); });
                    }
                });
            }
        }
